...
<div class="panel-form">
        ...
        <div class="form-group">
            ...
            <select name="tipoUsuario">
                ...
                <option value="comprador"
                    <%= "comprador".equals(u.getTipoUsuario()) ? "selected" : "" %>>
                    Comprador
                </option>

                <option value="vendedor"
                    <%= "vendedor".equals(u.getTipoUsuario()) ? "selected" : "" %>>
                    Vendedor
                </option>

                <option value="agente"
                    <%= "agente".equals(u.getTipoUsuario()) ? "selected" : "" %>>
                    Agente
                </option>

                <option value="administrador"
                    <%= "administrador".equals(u.getTipoUsuario()) ? "selected" : "" %>>
                    Administrador
                </option>
    ...
    <a class="link"
       href="UsuarioController?accion=listar">
...
<div class="panel-deco">
    <img src="images/landscape-mountain.jpg"
         alt="Paisaje"
